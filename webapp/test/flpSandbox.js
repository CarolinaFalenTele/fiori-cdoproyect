		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SolicitudProyect",
									"targetURL": "#solicitudproyect-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"solicitudproyect-display": {
								"semanticObject": "solicitudproyect",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=solicitudproyect",
									"url": sap.ui.require.toUrl("solicitudproyect")
								}
							}
						}
					}
